...
{
    public class ExpenseService : Service<Expense, ExpenseDto, CreateExpenseDto, UpdateExpenseDto>, IExpenseService
    {
        public ExpenseService(KhatoonServerDbContext context, IMapper mapper) : base(context, mapper) { }
    }
}
