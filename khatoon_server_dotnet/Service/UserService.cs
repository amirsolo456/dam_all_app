...
{
    public class UserService : Service<User, UserDto, CreateUserDto, UpdateUserDto>, IUserService
    {
        public UserService(KhatoonServerDbContext context, IMapper mapper) : base(context, mapper) { }
    }
}
