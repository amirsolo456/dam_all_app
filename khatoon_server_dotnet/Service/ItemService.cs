...
{
    public class ItemService : Service<Item, ItemDto, CreateItemDto, UpdateItemDto>, IItemService
    {
        public ItemService(KhatoonServerDbContext context, IMapper mapper) : base(context, mapper) { }
    }
}
