...
{
    public class AnimalService : Service<Animal, AnimalDto, CreateAnimalDto, UpdateAnimalDto>, IAnimalService
    {
        public AnimalService(KhatoonServerDbContext context, IMapper mapper) : base(context, mapper)
        {
        }
    }
}
