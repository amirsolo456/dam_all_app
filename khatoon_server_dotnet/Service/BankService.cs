...
{
    public class BankService : Service<Bank, BankDto, CreateBankDto, UpdateBankDto>, IBankService
    {
        public BankService(KhatoonServerDbContext context, IMapper mapper) : base(context, mapper) { }
    }
}
