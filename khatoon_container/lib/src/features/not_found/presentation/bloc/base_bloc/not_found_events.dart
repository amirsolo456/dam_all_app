...
class  NotFoundEvents extends RouteEvent {
  RouteEvent  pageNotFoundEvent(String routeName) => PageNotFoundEvent(routeName);
  RouteEvent shortKeyNotFoundEvent(String shortKey) => ShortKeyNotFoundEvent(shortKey);
